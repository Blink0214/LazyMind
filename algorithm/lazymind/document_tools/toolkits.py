"""Provider-neutral document toolkits with string/JSON inputs and outputs."""
...
class WriterToolkitBase:
    ...
    def apply_revision(
        ...
        # Import lazily because concrete capability toolkits are defined in
        # separate modules over this shared implementation base.
        from .resources import WriterResourceToolkit
